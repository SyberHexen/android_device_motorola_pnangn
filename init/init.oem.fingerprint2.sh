...
kernel_so_list=("/vendor/lib/modules/$GKI_PATH/ets_bix_mmi.ko" "/vendor/lib/modules/$GKI_PATH/fpsensor_spi_tee.ko")
kernel_so_name_list=("ets_bix_mmi.ko" "fpsensor_spi_tee.ko")
